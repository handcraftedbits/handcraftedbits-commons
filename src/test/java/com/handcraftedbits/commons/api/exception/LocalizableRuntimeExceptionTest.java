...
public final class LocalizableRuntimeExceptionTest {
     ...
     public final class Constructor {
          ...
          public final class GivenParamArgsMissing {
               ...
               public void shouldNotThrowNullPointerException () {
                    new LocalizableRuntimeException(bundleHelper, "key");
               }
          }
          ...
          public final class GivenParamArgsNull {
               ...
               public void shouldThrowNullPointerException () {
                    Assertions.assertThrows(NullPointerException.class, () -> {
                         new LocalizableRuntimeException(bundleHelper, "key", (Object[]) null);
                    });
               }
          }
          ...
          public final class GivenParamArgsSingleNullValue {
               ...
               @DisplayName("no exception should be thrown")
               public void shouldNotThrowNullPointerException () {
                    new LocalizableRuntimeException(bundleHelper, "key", new Object[] { null });
               }
          }
          ...
          public final class GivenParamBundleHelperNull {
               ...
               public void shouldThrowNullPointerException () {
                    Assertions.assertThrows(NullPointerException.class, () -> {
                         new LocalizableRuntimeException(null, "key");
                    });
               }
          }
          ...
          public final class GivenParamKeyNull {
               ...
               public void shouldThrowNullPointerException () {
                    Assertions.assertThrows(NullPointerException.class, () -> {
                         new LocalizableRuntimeException(bundleHelper, null);
                    });
               }
          }
     }
     ...
     public final class GetLocalizedMessage {
          private final LocalizableRuntimeException exception =
               new LocalizableRuntimeException(bundleHelper, "test.message", "abc");
