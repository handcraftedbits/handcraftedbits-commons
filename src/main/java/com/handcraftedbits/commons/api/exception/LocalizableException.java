...
/**
 * {@code LocalizableException} is used to simplify exception handling by allowing {@link Exception} messages to be
 * translated at the point at which they are caught.
 */

public class LocalizableException extends Exception {
     private static final long serialVersionUID = 27355458953799128L;
     ...
     /**
      * Creates a {@code LocalizableException}.
     ...
     public LocalizableException (@NonNull final ResourceBundleHelper bundleHelper, @NonNull final String key,
     ...
     /**
      * Looks up an interpolated message using a custom locale.
      * 
